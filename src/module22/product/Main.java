package module22.product;

import java.io.IOException;
import java.util.Scanner;

import static module22.product.Constants.*;
...
public class Main {
        ...
        private static void loadProductsFromFile() {
            ...
            if (confirm.equalsIgnoreCase("Y")) {
                try {
                    productManager.loadFromCSV("src/module22/product/product.csv");
        ...
        private static void saveProductsToFile() {
            ...
            if (confirm.equalsIgnoreCase("Y")) {
                try {
                    productManager.saveToCSV("src/module22/product/product.csv");
