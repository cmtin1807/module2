package molude2.vehicle.controller;

import molude2.vehicle.model.Car;
import molude2.vehicle.model.MotorBike;
import molude2.vehicle.model.Truck;
import molude2.vehicle.model.Vehicle;
                        ...
                        case 3:
                            ...
                            for (Truck truck : truckManager) {
                                if (truck.getLicensePlates().equals(licensePlatesRemove)){
                                    truckManager.remove(truck);
                                    System.out.println("Xoa thanh cong "+truck);
                                    BufferedWriter bufferedWriterTruck = new BufferedWriter(new FileWriter(fileMotorBike));
                                }
                            }
                            ...
                            for (Car car : carManager) {
                                if (car.getLicensePlates().equals(licensePlatesRemove)){
                                    truckManager.remove(car);
                                    System.out.println("Xoa thanh cong "+car);
                                }
                            }
                            for (MotorBike motorBiker : motorBikeManager) {
                                if (motorBiker.getLicensePlates().equals(licensePlatesRemove)){
                                    truckManager.remove(motorBiker);
                                    System.out.println("Xoa thanh cong "+motorBiker);
                                }
                            }
